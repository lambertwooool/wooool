...
class BriaRemoveBackgroundDetector:
    ...
    def __call__(self, input_image):
        ...
        with torch.no_grad():
            ...
            mask, detected_map = get_mask(self.model.model, input_image)
