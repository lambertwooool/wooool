...
import torch
from modules.model.ldm.models.diffusion.ddim import DDIMSampler
from modules.model.ldm.modules.diffusionmodules.util import make_ddim_timesteps
import math
...
def sampling_function(model, x, timestep, uncond, cond, cond_scale, model_options={}, seed=None):
        ...
        def calc_cond_uncond_batch(model, cond, uncond, x_in, timestep, model_options):
            ...
            while len(to_run) > 0:
                ...
                free_memory = devices.get_free_memory(x_in.device)
        ...
        if "sampler_cfg_function" in model_options:
            ...
            # TODO: cfg function
            # alpha = max(0.5, timestep / 15)
            # print(alpha)
            # return uncond + (cond - uncond) * cond_scale * alpha
