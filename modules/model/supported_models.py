import torch
from modules.model import model_base, model_helper, sd1_clip, sd2_clip, sdxl_clip
from modules.model import supported_models_base, latent_formats, diffusers_convert
...
class SD15(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.state_dict_prefix_replace(state_dict, replace_prefix)
        return state_dict
...
class SD20(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.transformers_convert(state_dict, "cond_stage_model.model.", "cond_stage_model.clip_h.transformer.text_model.", 24)
        return state_dict
...
class SDXLRefiner(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.transformers_convert(state_dict, "conditioner.embedders.0.model.", "cond_stage_model.clip_g.transformer.text_model.", 32)
        ...
        state_dict = model_helper.state_dict_key_replace(state_dict, keys_to_replace)
        return state_dict
    ...
    def process_clip_state_dict_for_saving(self, state_dict):
        ...
        state_dict_g = model_helper.state_dict_prefix_replace(state_dict_g, replace_prefix)
        return state_dict_g
...
class SDXL(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.transformers_convert(state_dict, "conditioner.embedders.1.model.", "cond_stage_model.clip_g.transformer.text_model.", 32)
