...
class SD15(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.state_dict_prefix_replace(state_dict, replace_prefix, filter_keys=True)
        return state_dict
...
class SD20(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.state_dict_prefix_replace(state_dict, replace_prefix, filter_keys=True)
        state_dict = model_helper.clip_text_transformers_convert(state_dict, "clip_h.", "clip_h.transformer.")
        return state_dict
...
class SDXLRefiner(supported_models_base.BASE):
    ...
    def process_clip_state_dict(self, state_dict):
        ...
        state_dict = model_helper.clip_text_transformers_convert(state_dict, "clip_g.", "clip_g.transformer.")
