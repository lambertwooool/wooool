...
class TAESD(nn.Module):
    ...
    def __init__(self, encoder_path=None, decoder_path=None):
        ...
        if encoder_path is not None:
            self.taesd_encoder.load_state_dict(model_helper.load_torch_file(encoder_path, safe_load=True))
        if decoder_path is not None:
            self.taesd_decoder.load_state_dict(model_helper.load_torch_file(decoder_path, safe_load=True))
