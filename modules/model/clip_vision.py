...
from modules.model import model_helper, model_patcher, model_loader, ops
...
class ClipVisionModel():
    def __init__(self, json_config):
        ...
        with ops.use_fcbh_ops(offload_device, self.dtype):
    ...
    def encode_image(self, image):
        ...
        with precision_scope(devices.get_autocast_device(self.load_device), torch.float32):
