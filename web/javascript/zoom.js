onUiLoaded(async() => {
    ...
    function applyZoomAndPan(elemId) {
        ...
        const image_container = targetElement.querySelector(".image-container")
        ...
        function createTooltip() {
            const toolTipElemnt = image_container.parentElement;
            ...
            const hotkeys = hotkeysInfo.map((info) => {
              ...
              hotkeys
                .forEach(hotkey => {
                  ...
                  p.innerHTML = `<b>${hotkey.key}</b> - <span>${hotkey.action}</span>`;
        ...
        function resetZoom() {
            ...
            if (canvas) {
                ...
                image_container.style.transform = `scale(${elemData[elemId].zoomLevel}) translate(${elemData[elemId].panX}px, ${elemData[elemId].panY}px)`;
                image_container.style.width = `${canvas_w}px`
                image_container.style.height = `${canvas_h}px`
            }
        ...
        function updateZoom(newZoomLevel, mouseX, mouseY) {
            ...
            image_container.style.transformOrigin = "0 0";
            image_container.style.transform = `translate(${elemData[elemId].panX}px, ${elemData[elemId].panY}px) scale(${newZoomLevel})`;
            image_container.style.overflow = "visible";
        ...
        function fitToElement() {
            ...
            const elementWidth = canvas.offsetWidth;
            const elementHeight = canvas.offsetHeight;

            const scrollbarWidth =
                window.innerWidth - document.documentElement.clientWidth;

            const screenWidth = parentElement.clientWidth - scrollbarWidth;
            ...
            image_container.style.transform = `translate(${offsetX}px, ${offsetY}px) scale(${scale})`;
        ...
        function updatePanPosition(movementX, movementY) {
            ...
            requestAnimationFrame(() => {
                image_container.style.transform = `translate(${elemData[elemId].panX}px, ${elemData[elemId].panY}px) scale(${elemData[elemId].zoomLevel})`;
                toggleOverlap("on");
            });
        }
