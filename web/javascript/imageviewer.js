...
function showModal(event) {
    ...
    const modalTitle = gradioApp().getElementById("modalTitle");
    const lb = gradioApp().getElementById("lightboxModal");
    modalImage.src = source.src;
    caption = source.parentElement.querySelector(".caption-label")
    modalTitle.innerHTML = caption.textContent;
...
function all_gallery_buttons() {
    var allGalleryButtons = gradioApp().querySelectorAll('.image_gallery .thumbnail-item');
...
function setupImageForLightbox(e) {
    ...
    var event = isFirefox ? 'mousedown' : 'dblclick';
...
function modalZoomSet(enable) {
    var modal = gradioApp().getElementById("lightboxModal");
    if (modal) modal.classList.toggle('modalFullscreen', enable);
}

function modalZoomToggle(event) {
    var modal = gradioApp().getElementById("lightboxModal");
    modalZoomSet(!modal.classList.contains('modalFullscreen'));
    event.stopPropagation();
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    modalImage.onclick = modalZoomToggle;
